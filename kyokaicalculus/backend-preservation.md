...
`lambda_K-seq` does not prove generated C or LLVM IR correct. Backend work must
...
| Checked arithmetic | Overflow, invalid shifts, division by zero, and bounds failure preserve Kyokai TPOE behavior without C undefined behavior or LLVM poison dependence. |
