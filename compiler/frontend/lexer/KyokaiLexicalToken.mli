...
(** Kyokai lexical-token boundary.

    This scanner is independent of the inherited Austral lexer and feeds the
    Phase 3 Kyokai surface parser. *)
...
(** Render a stable host-side explanation for Phase 3 tests and future
